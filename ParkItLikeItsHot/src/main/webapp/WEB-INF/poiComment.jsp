...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/styles/comment.css">
<link
			...
			<section class="bg-image"
				...
				<div class="mask" style="background-color: rgba(0, 0, 0, 0.6);">
					...
					<div class="button-container">
						<a href="singlePark.do?parkId=${poi.nationalPark.id}">
							<button class="button-5" role="button">Back To Park</button>
						</a>
					</div>
