...
START TRANSACTION;
USE `nationalparksdb`;
INSERT INTO `trail` (`id`, `name`, `length_in_miles`, `trail_difficulty`, `trail_map`, `description`, `latitude`, `longitude`, `national_park_id`, `create_date`, `last_update`, `enabled`) VALUES (1, 'Upper Yosemite Falls Trail', 6.6 , 'Hard', 'https://www.nps.gov/yose/planyourvisit/images/upperfallsmap_2.jpg?maxwidth=1300&maxheight=1300&autorotate=false', 'his section of the trail begins with a lot of switchbacks.Though steep,it is actually well-shaded', 37.74297, -119.60325, 1, NULL, NULL, 1);
