...
INSERT INTO `trail_comment` (`id`, `create_date`, `last_update`, `content`, `image_url`, `user_id`, `trail_id`) VALUES (2, '2024-08-26', NULL, 'Absolutely incredible nice easy hike with beautiful views,the overcast and clouds made the colors pop like crazy', 'https://grandfather.com/wp-content/uploads/2022/02/hiking-grandfather.jpg', 1, 1);
INSERT INTO `trail_comment` (`id`, `create_date`, `last_update`, `content`, `image_url`, `user_id`, `trail_id`) VALUES (3, '2024-08-26', NULL, 'Went sunrise to sunset.Switchbacks are beautiful but steep', 'https://uploads.alaska.org/destinations/sitka/_960xAUTO_fit_center-center_65_none/IMG_2952-Alainadestination-photos-aliana-brownalaska.org-sitka.jpg', 1, 1);
INSERT INTO `trail_comment` (`id`, `create_date`, `last_update`, `content`, `image_url`, `user_id`, `trail_id`) VALUES (4, '2024-08-26', NULL, 'Very nicely maintained trail with a good diversity of views.Downhill for the first half,uphill for the second half,but stunning vistas along both legs', 'https://i0.wp.com/www.highrockiesliving.com/wp-content/uploads/2020/03/adventure-hiking-trails-scaled.jpg?fit=1140%2C1140&ssl=1', 1, 1);
