...
INSERT INTO `mountain` (`id`, `name`, `elevation_in_meters`, `average_snowfall_in_inches`, `longitude`, `latitude`, `image_url`, `description`) VALUES (4, 'Angels Landing', 1760, '25', 37.2694, -112.9496, 'https://upload.wikimedia.org/wikipedia/commons/1/10/Zion_angels_landing_view.jpg', 'A challenging and iconic hike offering panoramic views of Zion Canyon.');
...
INSERT INTO `trail` (`id`, `name`, `length_in_miles`, `trail_difficulty`, `trail_map`, `description`, `latitude`, `longitude`, `national_park_id`, `create_date`, `last_update`, `enabled`) VALUES (2, 'Emerald Pools Trail', 3.0 , 'Moderate', 'https://www.citrusmilo.com/zionguide/maps/jbraun_emeraldp.jpg', 'The Lower Pool Trail is the easiest,gaining very little elevation and being smooth and wide,37.251123,-112.957232', 37.251123, -112.957232, 2, NULL, NULL, 1);
INSERT INTO `trail` (`id`, `name`, `length_in_miles`, `trail_difficulty`, `trail_map`, `description`, `latitude`, `longitude`, `national_park_id`, `create_date`, `last_update`, `enabled`) VALUES (3, 'Avalanche Lake', 5.9 , 'Moderate', 'https://enjoyyourparks.com/wp-content/uploads/2022/01/TRAIL-OF-THE-CEDARS-IMAGE-14.jpg', 'Generally considered a moderately challenging route,this is a very popular area for camping and hiking', 48.68067, -113.81904, 3, NULL, NULL, 1);
